...
async function confirmarYCobrar(from) {
  ...
  try {
    ...
    if (pedido.delivery && datos.shippingCost > 0) {
      itemsCheckout.push({ title: 'Envío a domicilio', quantity: 1, unit_price: datos.shippingCost });
    }
...
{"accion":"PEDIDO_LISTO_PARA_COTIZAR","items":[{"title":"NOMBRE","quantity":1,"unit_price":0}],"delivery":true,"direccion_calle":"CALLE","direccion_numero":"NUMERO","direccion_comuna":"COMUNA","direccion_interior":"","nombre":"NOMBRE","telefono":"TELEFONO","agendado":false}
